...
- В проекте представлены две реализации [main.py](https://github.com/PrudyvusP/region_finder/blob/master/main.py): наивная и реализованная 
  функцией `main()` и переработанная с учетом оптимизации (функция `main2()`)
  . Как напоминание о том, что в БД ходить на каждый адрес около 10 раз = 
  супер неоптимально.